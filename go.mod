...
replace github.com/daeuniverse/outbound => github.com/ppdragon16/outbound v0.0.0-next.29

//replace github.com/daeuniverse/quic-go => ../quic-go

replace github.com/daeuniverse/quic-go => github.com/ppdragon16/quic-go v0.0.0-next.4
