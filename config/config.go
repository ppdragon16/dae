...
type Global struct {
	...
	// TproxyReuseport is the number of tproxy listener sockets per l4proto.
	// >1 creates a SO_REUSEPORT listener pool and spreads packets by flow
	// hash via bpf_sk_assign, improving multi-core receive scaling under
